...
import { CommonButton,onClickCallingPhone } from './GeneralComponents';
    ...
    <>
      ...
      <div className='flex flex-col min-h-screen justify-between'>
        ...
        <main className='container m-auto mt-4 mx-40'>
            {children}
            <div className='absolute bottom-20 right-14 flex flex-col items-center animate-pulse animate-bounce gap-2 text-green-500 hover:text-green-300'>
